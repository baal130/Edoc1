...
import stripe
STRIPE_SECRET_KEY = getattr(settings, "STRIPE_SECRET_KEY", "sk_test_51HAz6mK450KPF3SvmxEbhWYxXlSeCyWqz3kgi84kq7K9wVfAmT6urWGbINpytrOmInGoaGMJB8iMarUbTv9KcOAy00vb5u6Zom")
...
class BillingProfileManager(models.Manager):
	def new_or_get(self, request):
		...
		created = False
		obj = None
		if user.is_authenticated: #it is property 
