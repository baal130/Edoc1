...
from .models import SignUp,UserDetails,UserDetailsServicePackagePrice #za query import 
from dataadd.models import Idiot
from .models import UserDetailsRating,UserDetailsGallery,UserDetailsService,UserDetailsTeam,UserDetailsDepartment,UserDetailsServicePrice
from .models import UserDetailsLanguage,UserDetailsSocialNetworks,UserDetailsFeatured,UserDetailsServicePackagePriceRemark
from .forms import ContactForm, SignUpForm,UserDetailsForm,UserWebDetailsForm,UserDetailsGalleryForm,UserDetailsServiceForm
from .forms import  UserDetailsDepartmentForm,UserDetailsTeamForm,UserDetailsInsuranceForm,PaymentmethodForm,UserDetailsExtraForm,UserDetailsServicePriceForm
from .forms import	UserDetailsServicePackagePriceForm,UserDetailsLanguageForm,UserDetailsSearchCitiesForm,UserDetailsSearchStateForm
from .forms import UserDetailsSearchSpecialityForm,UserDetailsSearchServiceForm,UserDetailsFormTime,UserDetailsSocialNetworksForm
from .forms import AppoitmentForm,ContactDoctorForm,ContactDoctorInListForm,UserDetailsServicePackagePriceRemarkForm
